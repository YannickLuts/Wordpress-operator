...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WordpressInfoSpec) DeepCopyInto(out *WordpressInfoSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WordpressInfoSpec.
func (in *WordpressInfoSpec) DeepCopy() *WordpressInfoSpec {
	if in == nil {
		return nil
	}
	out := new(WordpressInfoSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WordpressSpec) DeepCopyInto(out *WordpressSpec) {
	*out = *in
	out.WordpressInfo = in.WordpressInfo
}
